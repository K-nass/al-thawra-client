...
export function meta() {
  return generateMetaTags({
    title: "من نحن",
    description: "المؤسسة الصحفية الحكومية الأولى في الجمهورية اليمنية تأسست عام ١٩٦٢م، وتصدر عنها صحف: الثورة، الوحدة، الرياضة، ومجلة معين.",
    url: "/about",
    type: "website",
  });
}
        ...
        <div className="space-y-8">
          <div className="bg-[#d0e8f2] rounded-lg border border-black/10 p-8">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>المؤسسة الصحفية الحكومية الأولى في الجمهورية اليمنية تأسست عام ١٩٦٢م، وتصدر عنها صحف: الثورة، الوحدة، الرياضة، ومجلة معين.</p>
