...
export default function Home() {
  ...
  return (
    <main className="semafor-container py-4 md:py-8">
      ...
      <section className="mt-6 md:mt-10 xl:grid xl:grid-cols-[minmax(0,1fr)_280px] xl:gap-8 xl:items-start">
            ...
            return categoryPosts.map((data, idx) => {
              ...
              return (
                <section
                  ...
                  className={`mb-8 md:mb-12 ${isLast ? '' : 'pb-8 md:pb-12 border-b-2 border-black'} ${idx === 0 ? '' : 'mt-6 md:mt-10'}`}
                >
