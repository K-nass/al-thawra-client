...
export function AuthorCard({ name, role, bio, image, href, twitterUrl, articleTitle, articleUrl }: AuthorCardProps) {
  const shareUrl = articleUrl || (typeof window !== "undefined" ? window.location.href : "");
  
  const content = (
    <>
      <div className="flex flex-col items-center text-center py-8">
        {/* Author Image with circular frame and plus icon */}
        {image && (
        ...
        <div className="mt-6">
          <a 
            ...
            className="inline-flex items-center justify-center w-10 h-10 text-[#1a3a4a] transition-colors"
            aria-label="Twitter"
          >
  ...
  return (
    <div className="bg-white border border-gray-200 shadow-sm w-fit mx-auto">
      {href ? (
